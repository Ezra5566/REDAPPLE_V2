...
export function getStoreName(): string {
  return process.env.NEXT_PUBLIC_STORE_NAME || "REDAPPLEKE";
}
...
export function getStoreDescription(): string {
  return (
    ...
    "REDAPPLEKE — genuine Apple products for Africa. iPhones, iPads, Macs, AirPods and accessories, delivered across Kenya."
  );
}
