    ...
    <div className="w-full">
      ...
      <div className="relative overflow-hidden">
        ...
        >
          ...
          <p className="mt-4 text-sm font-medium text-gray-700 dark:text-neutral-300">
            {t("finalizingPayment")}
          </p>
        </div>
        ...
        <div className="relative min-h-12">
          ...
          >
            <div className="w-5 h-5 border-2 border-gray-300 dark:border-neutral-600 border-t-gray-600 dark:border-t-neutral-300 rounded-full animate-spin" />
          </div>
            ...
            {available && showDivider && (
              <div className="relative mt-4">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white dark:bg-neutral-950 text-gray-500 dark:text-neutral-400">{t("or")}</span>
                </div>
              </div>
            )}
          </div>
