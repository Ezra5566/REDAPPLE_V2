...
export function MobileMenu({
  ...
  // Shared link style
  const linkClass =
    "text-left text-gray-700 dark:text-neutral-200 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-neutral-800 rounded-lg px-3 py-2.5 text-base transition-colors";

  // Shared button style for items with children (chevron)
  const categoryButtonClass =
    "flex items-center justify-between w-full text-left text-gray-700 dark:text-neutral-200 hover:text-gray-900 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-neutral-800 rounded-lg px-3 py-2.5 text-base transition-colors";
      ...
      >
        ...
        <div className="hidden md:flex items-center justify-between px-4 h-16 border-b border-gray-200 relative overflow-hidden">
          ...
          <button
            type="button"
            onClick={popPanel}
            className={`flex items-center gap-2 text-gray-700 dark:text-neutral-200 hover:text-gray-900 dark:hover:text-white text-base font-semibold cursor-pointer transition-all duration-300 ease-in-out absolute left-4 ${
              currentPanel.kind !== "main"
                ? "translate-x-0 opacity-100"
                : "translate-x-8 opacity-0 pointer-events-none"
            }`}
              ...
              >
                ...
                <div className="md:hidden px-4 py-2 border-b border-gray-200">
                  <button
                    type="button"
                    onClick={popPanel}
                    className="flex items-center gap-2 text-gray-700 dark:text-neutral-200 hover:text-gray-900 dark:hover:text-white py-2 text-base font-medium"
                  >
                    <ArrowLeft className="w-5 h-5" />
                ...
                <div className="border-t border-gray-200 px-4 py-3">
                  <Link
                    ...
                    onClick={() => handleOpenChange(false)}
                    className="block w-full text-center text-sm text-gray-500 dark:text-neutral-400 hover:text-gray-900 dark:hover:text-white py-2 transition-colors"
                  >
